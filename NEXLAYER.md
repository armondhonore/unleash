...
**Live:** [https://relaxed-weasel-unleash.cloud.nexlayer.ai](https://relaxed-weasel-unleash.cloud.nexlayer.ai)  
...
**unleash** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/unleashorg/unleash-server:latest
    path: /
    servicePorts:
    - 4242
    vars:
      DATABASE_URL: "postgres://unleash:${POSTGRES_PASSWORD}@postgres.pod:5432/unleash"
      DATABASE_SSL: "false"
      LOG_LEVEL: warn
  - name: postgres
